...
fn_hdf5_add_to_dataset(FRAME, MFMC.fname, [sequence_path, 'MFMC_DATA'],             'M', [], [no_time_pts, no_ascans, inf], 3);
fn_hdf5_add_to_dataset(FRAME, MFMC.fname, [sequence_path, 'MFMC_DATA_IM'],          'O', [], [no_time_pts, no_ascans, inf], 3);
